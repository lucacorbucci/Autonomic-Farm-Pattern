...
class Emitter {
   ...
   public:
    ...
    Emitter(std::vector<SafeQueue<Task<T, U> *> *> *outputQueue, std::vector<Worker<T, U> *> workerQueue, int nWorker, SafeQueue<Feedback *> *feedbackQueue, std::vector<Task<T, U> *> inputVector, SafeQueue<Feedback *> *feedbackQueueWorker) {
